                    ...
                    <div className="flex justify-center">
                        ...
                        >
                            <button
                                ...
                                className="bg-gray-600 dark:bg-gray-700  w-[350px] h-[60px] flex  justify-center items-center   fixed bottom-4  text-white rounded-3xl px-5 py-5"
                            >
                                        ...
                                        <div className="h-full w-screen  bg-slate-300 dark:bg-black dark:border-gray-700 dark:text-white text-black   flex flex-col py-6 shadow-xl">
                                            ...
                                            >
                                                ...
                                                <div className="mt-4 px-4  fixed bottom-5">
                                                    <button
                                                        x-on:click="open = false"
                                                        className="w-[350px] h-[60px] bg-gray-600 dark:bg-gray-700 rounded-2xl  px-3 py-2  text-white"
                                                    >
                                                        AGGIUNGI
                                                    </button>
                                                </div>
                    ...
                    <div className="flex flex-col justify-center items-center mt-20">
                        ...
                        {todos.length === 0 ? (
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="dark:text-gray-300 font-bold text-xl">
                                    AGGIUNGI LE TUE TODO
                                </span>
                            </div>
                        ) : (
                            ""
